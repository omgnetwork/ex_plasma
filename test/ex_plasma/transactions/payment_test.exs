defmodule ExPlasma.Transactions.PaymentTest do
  ...
  test "encode/1 RLP encodes a payment transaction" do
    ...
    assert rlp_encoded ==
      <<248, 81, 1, 196, 195, 128, 128, 128, 245, 244, 1, 148, 29, 246, 47, 41, 27,
         ...
         0, 110, 136, 0, 0, 0, 0, 0, 0, 0, 1, 148, 29, 246, 47, 41, 27, 46, 150, 159,
         176, 132, 157, 153, 217, 206, 65, 226, 241, 55, 0, 110>>
  end
end
